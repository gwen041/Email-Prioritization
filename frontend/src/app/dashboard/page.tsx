                                        ...
                                        {Object.entries(selectedEmail.factors || {}).map(([key, factor]: [string, any]) => (
                                            <div key={key} className="space-y-3">
                                                <div className="flex justify-between text-[11px] font-bold tracking-tight">
                                                    ...
                                                    <span className="text-slate-900">{factor.weighted}/{factor.max || (key === 'deadline' ? '40' : key === 'sender' ? '30' : key === 'complexity' ? '20' : '10')}</span>
                                                </div>
                                                <div className="h-2 bg-slate-200 rounded-full overflow-hidden">
                                                    <div 
                                                        ...
                                                        style={{ width: `${(factor.weighted / (factor.max || (key === 'deadline' ? 40 : key === 'sender' ? 30 : key === 'complexity' ? 20 : 10))) * 100}%` }} 
                                                    />
                                                </div>
                                            </div>
                                        ))}
